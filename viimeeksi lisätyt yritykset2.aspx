<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viimeeksi lisätyt yritykset2.aspx.cs" Inherits="nettisivut_app.viimeeksilisatyt2" %>
...
<body class="Etusivu">
  ...
  <p class="custom-p">No more results to show.<br></p>
<div>
	  <h3 style="margin-top:535px"><a href="viimeeksi%20lisätyt%20yritykset.aspx" style="color:black;text-decoration:none">Previous page</a></h3>
	  </div>
        </div>
    <div class="väli2">
    </div>
